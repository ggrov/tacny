...
namespace Microsoft.Dafny
{
    public class Program
    {
        ...
        public Program(Program program)
        {
            ...
            DefaultModule = program.DefaultModule;
            DefaultModuleDef = program.DefaultModuleDef;
            BuiltIns = program.BuiltIns;
            Modules = program.Modules.GetRange(0, program.Modules.Count);
            CompileModules = program.CompileModules.GetRange(0, program.CompileModules.Count);
            TranslationTasks = program.TranslationTasks.GetRange(0, program.TranslationTasks.Count);
        }
    ...
    public class MapType : CollectionType
    {
        ...
        public MapType(bool finite, Type domain, Type range)
            : base(domain)
        {
    ...
    public class TypeParameter : Declaration
    {
        ...
        public bool IsAbstractTypeDeclaration
        { // true if this type parameter represents t in type t;
    ...
    public class DefaultModuleDecl : ModuleDefinition
    {
        public DefaultModuleDecl()
            : base(Token.NoToken, "_module", false, false, null, null, null, true)
        {
        }
    ...
    public interface IVariable
    {
        ...
        bool HasBeenAssignedUniqueName
        {  // unique names are not assigned until the Translator; if you don't already know if that stage has run, this boolean method will tell you
            get;
        }
    ...
    public class OrStmt : BlockStmt
    {
        public readonly Expression Rhs;
        public readonly Expression Lhss;
        public readonly List<Statement> Brhs;
        public readonly List<Statement> Blhs;

        // expression || expression
        public OrStmt(IToken tok, IToken endTok, List<Expression> lhss, Expression rhs)
            ...
            : base(tok, endTok, null)
        {
            Contract.Requires(tok != null);
            Contract.Requires(endTok != null);
            Contract.Requires(cce.NonNullElements(blhs));
            Contract.Requires(blhs.Count != 0);
            Contract.Requires(rhs != null);
            Rhs = rhs;
            Blhs = blhs;
        }
            ...
            : base(tok, endTok, null)
        {
            ...
            Contract.Requires(endTok != null);
            Contract.Requires(cce.NonNullElements(blhs));
            Contract.Requires(cce.NonNullElements(brhs));
            Contract.Requires(blhs.Count != 0);
            Contract.Requires(brhs.Count != 0);
            Blhs = blhs;
            Brhs = brhs;
        }
    ...
    {
        public MultiSetDisplayExpr(IToken tok, List<Expression> elements)
            : base(tok, elements)
        {
            Contract.Requires(tok != null);
            Contract.Requires(cce.NonNullElements(elements));
    ...
    public class BoxingCastExpr : Expression
    {  // a BoxingCastExpr is used only as a temporary placeholding during translation
        public readonly Expression E;
    ...
    public class UnboxingCastExpr : Expression
    {  // an UnboxingCastExpr is used only as a temporary placeholding during translation
        public readonly Expression E;
        public readonly Type FromType;
        public readonly Type ToType;
        [ContractInvariantMethod]
