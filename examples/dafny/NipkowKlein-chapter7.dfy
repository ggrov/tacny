...
{
  // non-standard semantics for match as you should be able to match on arbitrary stuff
  // maybe cases should return an object?
  // actually, maybe a tactic should be working on an object holding information?
  match cases(c) with
    Success => 
	Invariant =>
	...
